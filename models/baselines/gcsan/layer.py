...
from tensorflow.keras.activations import sigmoid, tanh, softmax, relu, gelu, swish
...
class FeedForward(Model):
    ...
    def __init__(self, hidden_size, inner_size, hidden_dropout_prob, hidden_act, layer_norm_eps):
        ...
        self.LayerNorm = LayerNormalization(hidden_size, eps=layer_norm_eps)
...
class TransformerEncoder(Model):
    ...
    def __init__(
        ...
        self.layer = tf.TensorArray([copy.deepcopy(layer) for _ in range(n_layers)])
